...
;-----------------
	...
	DB 1,100,0,8			; Other parameters, 10 extra pages and 8 for MSX Audio
...
begin_program:
	...
	incbin "player_music_module.tmp"; make sure to have the player setup for MSX Audio as well, look at prepare_other_files.sh
